  ...
  return (
    <div>
      <div className="bg-[--bg] bg-opacity-15">
        ...
        <div className=" pt-28">
          <div className="w-10/12 h-[750px] mx-auto py-10 md:flex  bg-gradient-to-r from-[#0d6efd] to-[#0dcaf0]">
            <div className="w-[46%] pl-10 text-center text-white">
              ...
              <div className="h-[400px] w-[300px] bg-white mx-auto my-7">
            ...
            <div className="w-[53%] h-[700px]  text-white pr-10 pt-10">
              <div className='w-full h-2/3 px-8 py-10  bg-[#0d6efd]'>
                <h1 className='text-5xl font-sans font-extrabold'>Pay Account</h1>
                <h1 className='text-2xl font-sans font-extrabold py-2'>Account Name: INFINITE INTELLIGENCE</h1>
                <h1 className='text-2xl font-sans font-[700] py-5'>Axis Bank Account Number: 922020040517727</h1>
                <h1 className='text-2xl font-sans font-[700] py-5'>IFSC Code: UTIB0000568</h1>
                <h1 className='text-2xl font-sans font-[700]'>UPI ID: manish1991rishikesh-4@okaxis</h1>
                <button
